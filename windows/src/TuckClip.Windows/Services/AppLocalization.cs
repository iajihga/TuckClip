...
public static class AppLocalization
{
    private static readonly IReadOnlyDictionary<string, string> English =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["TuckClip 更新"] = "TuckClip Update",
            ["TuckClip {0} 已可用"] = "TuckClip {0} is available",
            ["下载完成后会安全替换当前版本并重新启动。"] = "After download, TuckClip will safely replace the current version and restart.",
            ["此版本没有附加更新说明。"] = "No additional release notes were provided.",
            ["更新包会在安装前校验完整性。"] = "The update package will be verified before installation.",
            ["稍后"] = "Later",
            ["下载并安装"] = "Download and Install",
            ["正在下载更新…"] = "Downloading update…",
            ["正在下载更新… {0}%"] = "Downloading update… {0}%",
            ["正在检查更新…"] = "Checking for updates…",
            ["便携版不支持应用内更新，请安装正式安装版。"] = "In-app updates require the installed edition, not the portable edition.",
            ["当前已是最新版本。"] = "You already have the latest version.",
            ["暂时无法检查更新，请稍后重试。"] = "Updates cannot be checked right now. Try again later.",
            ["更新失败，当前版本没有被替换。请稍后重试。"] = "The update failed and the current version was kept. Try again later.",
